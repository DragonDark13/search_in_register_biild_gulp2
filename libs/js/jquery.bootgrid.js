    ...
    */
            ...
            if (infoItems.length > 0)
            {
                var end = (this.current * this.rowCount),
                    infos = $(this.options.templates.infos.resolve(getParams.call(this, {
                        ...
                        total: this.options.hasMore ? this.total + '+' : this.total
                    })));
                ...
                $.each(that.columns, function (j, column)
                {
                    if (column.visible)
                    {
                        ...
                        cells += tpl.cell.resolve(getParams.call(that, {
                            ...
                            title: (row[column.id] == null || row[column.id] === "") ? "&nbsp;" : row[column.id]
                        }));
                    }
                });
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            body: "<tbody></tbody>",
            cell: "<td class=\"{{ctx.css}}\" title='{{ctx.title}}' style=\"{{ctx.style}}\">{{ctx.content}}</td>",
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row\"><div class=\"col-sm-6\"><p class=\"{{css.infos}}\"></p></div><div class=\"col-sm-6 infoBar\"><p class=\"{{css.pagination}}\"></p></div></div></div>",
        ...
        /**
         * Contains special flag from server if there is more records.
         *
         * @property hasMore
         * @type Boolean
         * @for defaults
    ...
    /**
     * added by Glalex, 18_07_2018
     * show message in bootgrid
     *
     * @method showBootgridMsg
     * @param [msg] "String" message to show
     * @chainable
     **/
    Grid.prototype.showBootgridMsg = function(msg)
    {
        // debugger;
        this.cachedParams.lbl.noResults = msg;
        renderNoResultsRow.call(this);
    };
